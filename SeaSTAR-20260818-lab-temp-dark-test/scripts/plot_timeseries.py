...
# the data: a warm wash while the heater was on, and a grey one over anything
# that upset the measurement. the bands are hatched differently as well as
# coloured differently, so they are still told apart in greyscale or in print.
# this is a dark test, so the state of the lamp says nothing about the
# measurement and does not get a band:
BAND_STYLES = {
