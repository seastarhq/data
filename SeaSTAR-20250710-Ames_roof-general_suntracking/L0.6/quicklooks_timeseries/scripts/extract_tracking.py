...
for timestep in range(len(L06_data)):
    ...
    euclidian_dist = L06_data[timestep]['euclidian_dist']
    camera_sun_x = L06_data[timestep]['camera_sun_x']
    camera_sun_y = L06_data[timestep]['camera_sun_y']
    camera_sun_brightness = L06_data[timestep]['camera_sun_brightness']
    camera_target_x = L06_data[timestep]['camera_target_x']
    camera_target_y = L06_data[timestep]['camera_target_y']
    tracking_flags = L06_data[timestep]['tracking_flags']


    sys.stdout.write(f"{timestamp.isoformat()} {euclidian_dist} {camera_sun_x} {camera_sun_y} {camera_sun_brightness} {camera_target_x} {camera_target_y} {tracking_flags} \n")
